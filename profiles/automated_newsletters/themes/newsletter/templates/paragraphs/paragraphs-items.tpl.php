<table width="600" align="center" cellpadding="0" cellspacing="0"
  ...
  <tr>
    <td colspan="3">
      <table width="600" align="center" cellpadding="0" cellspacing="0" bgcolor="#3E3E3E">
        <tbody><tr>
          <td colspan="2" height="31"></td>
        </tr>
        <tr>
          <!-- left column (Afmelden and Snel naar) -->
          <td valign="top">
            <table align="center" cellpadding="0" cellspacing="0">
                ...
                <td valign="top">
                  <table align="center" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                      <td width="14"></td>
                      <td>
                        <b style="font-size: 16px; line-height: 23px; font-weight: bold; color: #ffffff; font-family: Arial, Helvetica, sans-serif;">
                          Afmelden
                        </b>
                      </td>
                    </tr>
              ...
              <tr>
                <td colspan="2">
                  <table width="395" align="center" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                      <td colspan="2" height="9"></td>
                    </tr>
                    <tr>
                      <td width="14"></td>
                      <td style="font-size: 10px; line-height: 12px; color: #ffffff; font-family: Arial, Helvetica, sans-serif;">
                        DISCLAIMER
                      </td>
                    </tr>
                    <tr>
